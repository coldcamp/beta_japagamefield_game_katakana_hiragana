...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    // Removed ALTER TABLE to avoid duplicate column error
    // $alter_sql = "ALTER TABLE scores ADD game VARCHAR(50) NOT NULL DEFAULT 'typeattack'";
...
<head>
    ...
    <title>Type Attack Game - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Type Attack Game</h1>
        <p>Type the romanization of the displayed Hiragana character as fast as you can!</p>
