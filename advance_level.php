...
<head>
    ...
    <title>Advance Level - Gamified Hiragana and Katakana Learning</title>
...
<body>
    <div class="home-container">
        ...
        <h1>Advance Level</h1>
        <p>Welcome to the Advance Level section, <?php echo htmlspecialchars($username); ?>! Here you can access advanced Hiragana and Katakana learning materials.</p>
        <nav>
            <ul style="list-style: none; padding: 0;">
                <li><button class="btn" onclick="window.location.href='advance_hiragana.php'">Advance Hiragana</button></li>
                <li><button class="btn" onclick="window.location.href='advance_katakana.php'">Advance Katakana</button></li>
                <li><button class="btn" onclick="window.location.href='advance_hiragana_quiz.php'">Advance Hiragana Quiz</button></li>
                <li><button class="btn" onclick="window.location.href='advance_quiz.php'">Advance Katakana Quiz</button></li>
                <li><button class="btn" onclick="window.location.href='advance_game.php'">Advance Game</button></li>
            </ul>
        </nav>
        <div class="back-link">
