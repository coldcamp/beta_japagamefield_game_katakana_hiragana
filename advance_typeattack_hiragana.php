...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_typeattack_hiragana';
...
<head>
    ...
    <title>Advance Type Attack Hiragana - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Type Attack Hiragana</h1>
        <p>Type the romanization of the displayed advanced Hiragana character as fast as you can!</p>
