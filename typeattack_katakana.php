...
<head>
    ...
    <title>Type Attack Katakana Game - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Type Attack Katakana Game</h1>
        <p>Type the romanization of the displayed Katakana character as fast as you can!</p>
