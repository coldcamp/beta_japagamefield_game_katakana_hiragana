...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_memorycard_katakana_romanji';
...
<head>
    ...
    <title>Advance Memory Card Katakana with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Memory Card Katakana with Romanji</h1>
        <p>Click on cards to flip them. Match pairs of advanced Katakana characters! Romanji is shown below each character.</p>
