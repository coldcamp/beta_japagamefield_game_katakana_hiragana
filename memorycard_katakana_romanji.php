...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'memorycard_katakana_romanji';
...
<head>
    ...
    <title>Memory Card Katakana Game with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Memory Card Katakana Game with Romanji</h1>
        <p>Click on cards to flip them. Match pairs of Katakana characters! Romanji is shown below each character.</p>
