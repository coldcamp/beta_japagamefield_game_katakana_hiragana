...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'typeattack_katakana_romanji';
...
<head>
    ...
    <title>Type Attack Katakana Game with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Type Attack Katakana Game with Romanji</h1>
        <p>Type the romanization of the displayed Katakana character as fast as you can! Romanji is shown below each character.</p>
        ...
        <div class="back-link">
            <a href="game.php">Back to Games</a>
        </div>
    </div>
