...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_typeattack_katakana_romanji';
...
<head>
    ...
    <title>Advance Type Attack Katakana with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Type Attack Katakana with Romanji</h1>
        <p>Type the romanization of the displayed advanced Katakana character as fast as you can! Romanji is shown below each character.</p>
