...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_memorycard_hiragana';
...
<head>
    ...
    <title>Advance Memory Card Hiragana - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Memory Card Hiragana</h1>
        <p>Click on cards to flip them. Match pairs of advanced Hiragana characters!</p>
    ...
    <script>
        const characters = ['が', 'ざ', 'だ', 'ば', 'ぱ', 'きゃ', 'しゃ', 'ちゃ', 'にゃ', 'ひゃ', 'みゃ', 'りゃ', 'ぎゃ', 'じゃ', 'びゃ', 'ぴゃ'];
