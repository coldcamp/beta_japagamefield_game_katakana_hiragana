...
<head>
    ...
    <title>Memory Card Katakana Game - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Memory Card Katakana Game</h1>
        <p>Click on cards to flip them. Match pairs of Katakana characters!</p>
    ...
    <script>
        const characters = ['ア', 'イ', 'ウ', 'エ', 'オ', 'カ', 'キ', 'ク'];
