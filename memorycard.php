...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    // $alter_sql = "ALTER TABLE scores ADD game VARCHAR(50) NOT NULL DEFAULT 'memorycard'";
...
<head>
    ...
    <title>Memory Card Game - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        ...
        <p>Click on cards to flip them. Match pairs of Hiragana characters!</p>
    ...
    <script>
        const characters = ['あ', 'い', 'う', 'え', 'お', 'か', 'き', 'く'];
