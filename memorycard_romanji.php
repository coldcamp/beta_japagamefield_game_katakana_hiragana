...
<head>
    ...
    <title>Memory Card Game with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Memory Card Game with Romanji</h1>
        <p>Click on cards to flip them. Match pairs of Hiragana characters! Romanji is shown below each character.</p>
