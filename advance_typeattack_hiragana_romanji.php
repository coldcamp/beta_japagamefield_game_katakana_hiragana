...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_typeattack_hiragana_romanji';
...
<head>
    ...
    <title>Advance Type Attack Hiragana with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Type Attack Hiragana with Romanji</h1>
        <p>Type the romanization of the displayed advanced Hiragana character as fast as you can! Romanji is shown below each character.</p>
