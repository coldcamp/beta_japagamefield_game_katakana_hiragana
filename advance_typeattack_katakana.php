...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_typeattack_katakana';
...
<head>
    ...
    <title>Advance Type Attack Katakana - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Type Attack Katakana</h1>
        <p>Type the romanization of the displayed advanced Katakana character as fast as you can!</p>
