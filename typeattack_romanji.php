...
<head>
    ...
    <title>Type Attack Game with Romanji - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Type Attack Game with Romanji</h1>
        <p>Type the romanization of the displayed Hiragana character as fast as you can! Romanji is shown below each character.</p>
