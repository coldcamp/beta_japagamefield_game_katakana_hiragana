...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_score'])) {
    ...
    $game = 'advance_memorycard_katakana';
...
<head>
    ...
    <title>Advance Memory Card Katakana - Hiragana and Katakana</title>
...
<body>
    <div class="game-container">
        <h1>Advance Memory Card Katakana</h1>
        <p>Click on cards to flip them. Match pairs of advanced Katakana characters!</p>
    ...
    <script>
        const characters = ['ガ', 'ザ', 'ダ', 'バ', 'パ', 'キャ', 'シャ', 'チャ', 'ニャ', 'ヒャ', 'ミャ', 'リャ', 'ギャ', 'ジャ', 'ビャ', 'ピャ'];
